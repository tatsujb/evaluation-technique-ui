    ...
    render(){
        return (
            <div className="MenuLeft">
                ...
                <div className="MenuButton">Java FX</div>
                <div className="MenuButton">Python QT5</div>
                <div className="MenuButton">Ruby</div>
                <div className="MenuButton">PHP</div>
            </div>
        )
    }
}
export default MenuEvalJobAndDB;